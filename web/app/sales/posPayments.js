    ...
    return (
      <div style={{ display: "flex", alignItems: "center", margin: "5px 0" }}>
        ...
        <div style={{ flex: "0 0 80px", textAlign: "center" }}>
          ...
          <div style={{ textTransform: "capitalize", fontSize: "13px", color }}>
            {input.value.method}
          </div>
        </div>
        <Field
      ...
      <div>
        {fields.map((f, fi) => (
          <Field
            ...
            name={f}
            component={Payment}
            remove={fields.remove.bind(this, fi)}
          />
        ))}
      </div>
    );
        ...
        >
          ...
          >
            <FatButton
              icon="attach_money"
              color="green"
              onClick={this.addPayment.bind(this, "cash")}
              disabled={valid}
            >
              Cash
            </FatButton>
            <FatButton
              icon="credit_card"
              color="red"
              onClick={this.addPayment.bind(this, "credit")}
              disabled={valid}
            >
              Credit
            </FatButton>
