  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <FormInput
            input={{ value: search, onChange: this.search }}
              ...
              >
                <Column
                  ...
                  cellRenderer={({ cellData }) => (
                    <div>
                      {cellData && moment(cellData).format("M/D/YY h:mm a")}
                    </div>
                  )}
                />
        ...
        <Dialog
          modal={false}
          open={!!match.params.saleID}
          onRequestClose={this.close}
          autoScrollBodyContent={true}
        >
          {match.params.saleID && (
            <SaleDetail saleID={match.params.saleID} close={this.close} />
          )}
        </Dialog>
      </div>
    );
