        ...
        <div style={{display:'flex'}}>
          ...
          <div style={{display:'flex', flexDirection:'column'}}>
            <div style={{backgroundColor:'#f2f2f2', borderRadius:'6px', paddingBottom:'10px', marginTop:'10px'}}>
              <Field name='purchasePrice' component={FormInput} label='Purchase Price' type='currency' style={{width:'120px'}} />
              <Field name='salePrice' component={FormInput} label='Sale Price' type='currency' style={{width:'120px'}} />
            </div>
          </div>
        </div>
