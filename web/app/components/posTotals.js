      ...
      return (
        <div style={{display:'flex', alignItems:'center'}}>
          ...
          <FormInput label={'Tax (' + taxRate.input.value + ')'}
                     ...
                     type='currency' style={{flex:'1 1 100px'}} disabled={true} />
